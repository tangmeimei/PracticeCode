...
const about = () => {
  return (
    <>
       <Head>
        <title>Learn From Youtube</title>
      ...
      <main className="flex flex-col items-center justify-center">
        <Layout className='pt-16'>
            ...
            <div className='grid w-full grid-cols-8 gap-16'>
                ...
                <div className='col-span-3 border-2 border-solid border-dark h-max relative rounded-2xl p-8 bg-light'>
                    <div className='absolute top-0 -right-3 bg-dark w-[102%] h-[103%] -z-10 rounded-[2rem]'/>
